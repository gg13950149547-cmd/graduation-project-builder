...
try:
    from .thesis_figure_contract import drawio_er_geometry_report
except ImportError:
    from thesis_figure_contract import drawio_er_geometry_report
...
def main() -> int:
    ...
    parser.add_argument("--family", default="er", choices=["er"], help="Structural figure family to validate.")
    ...
    if args.family != "er":
        raise SystemExit(f"unsupported structural figure family: {args.family}")
